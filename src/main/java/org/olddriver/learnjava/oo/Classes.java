...
public class Classes{
	 ...
	 * 若子类继承多个独立接口中字段同名，若该字段定义在同一接口中，不会导致歧义继承(A接口中定义某个字段，BC接口继承A，D继承BC)
     ...
     * 当子类继承多个独立接口中实例方法冲突，若该方法定义在同一接口中，不会导致歧义继承(A接口中定义某个方法，BC接口继承A，D继承BC)
     ...
     * 子类继承多个独立接口中类型同名，若该类型定义在同一接口中，不会导致歧义继承(A接口中定义某个字段，BC接口继承A，D继承BC)
